  ...
  return (
    <AppLayout>
      <div className="mb-4">
        ...
        <p className="text-sm text-muted-foreground">Besoin d'aide ? Nous sommes là pour vous aider</p>
      </div>
            ...
            <Accordion type="single" collapsible className="w-full">
              <AccordionItem value="item-1">
                ...
                <AccordionContent>
                  ...
                  votre réservation et en cliquant sur "Annuler la réservation". Les conditions d'annulation dépendent
                  du délai avant la date de réservation.
                </AccordionContent>
              </AccordionItem>
              <AccordionItem value="item-2">
                <AccordionTrigger>Que faire en cas de panne ?</AccordionTrigger>
                <AccordionContent>
                  En cas de panne, utilisez la fonction "Signaler un incident" dans les détails de votre réservation.
                  Notre équipe sera immédiatement notifiée et prendra contact avec vous pour vous assister.
                </AccordionContent>
              </AccordionItem>
              ...
              <AccordionItem value="item-4">
                ...
                <AccordionContent>
                  Oui, tous nos véhicules sont assurés. Une assurance de base est incluse dans le prix de la location.
                  Des options d'assurance complémentaires sont disponibles lors de la réservation.
                </AccordionContent>
              </AccordionItem>
            </Accordion>
          </CardContent>
        ...
        <Card>
          ...
          <CardContent>
            <p className="text-sm mb-4">
              En cas d'urgence (accident, vol), contactez immédiatement notre numéro d'urgence disponible 24h/24 et 7j/7
              :
            </p>
